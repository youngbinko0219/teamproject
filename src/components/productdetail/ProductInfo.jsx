  ...
  return (
    <div className="product-info">
      ...
      <div className="product-review">
        <ReviewSummarySimple averageRating={averageRating} totalReviews={totalReviews} />
      ...
      <div className="rental-date-section">
        ...
        <RentalDatePicker selectedDate={selectedRentalDate} onSelect={setSelectedRentalDate} />
      </div>
